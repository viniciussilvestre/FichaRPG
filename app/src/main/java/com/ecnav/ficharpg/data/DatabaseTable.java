...
public class DatabaseTable
{
    ...
    private static class DatabaseOpenHelper extends SQLiteOpenHelper
    {
        ...
        private static final String FTS_TABLE_CREATE = "CREATE VIRTUAL TABLE " + FTS_VIRTUAL_TABLE + " USING fts3 (" + COL_WORD + ", " + COL_DEFINITION + ")";
        ...
        private void loadCharacterNames() throws IOException
        {
            final Resources resources = helperContext.getResources();
            InputStream inputStream = resources.openRawResource(R.raw.characters_names);
